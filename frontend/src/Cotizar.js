  ...
  return (
    <Container className="mt-5" style={{ marginBottom: '60px' }}>
      <Row className="justify-content-center">
        <Col md={8} lg={7}>
          <div style={{ background: '#fff', borderRadius: '14px', boxShadow: '0 8px 28px rgba(0,0,0,0.09)', padding: '48px 40px', textAlign: 'center' }}>

            <div style={{ width: '64px', height: '64px', borderRadius: '50%', background: COLOR_BG_WARM, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
            ...
            <div style={{ background: COLOR_BG_WARM, borderRadius: '10px', padding: '20px 24px', textAlign: 'left', marginBottom: '28px' }}>
              ...
              target="_blank"
              rel="noreferrer"
              style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', background: COLOR_WHATSAPP, color: '#fff', fontWeight: '700', fontSize: '1.05rem', padding: '14px 32px', borderRadius: '8px', textDecoration: 'none', boxShadow: '0 6px 16px rgba(63,164,106,0.35)', transition: 'transform 0.15s' }}
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginTop: '22px', padding: '8px 18px', borderRadius: '999px', border: '1px solid #e0d5c8', color: COLOR_DARK, fontSize: '0.85rem', fontWeight: '500' }}>
